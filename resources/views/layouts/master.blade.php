               ...
               <div class="col-md-4">
                   <div class="full">
                      ...
                      <div class="information_f">
                        <p><strong>ADDRESS:</strong> Trường Cao Đẳng FPT Polytechnic </p>
                        <p><strong>TELEPHONE:</strong> +123456789 </p>
                        <p><strong>EMAIL:</strong> thu@gmail.com</p>
                      </div>
                   </div>
               </div>
               <div class="col-md-8">
